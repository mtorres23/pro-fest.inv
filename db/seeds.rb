...
Client.create!(id: 1, company_id: 'Premier Events', access_key: 0058, address: '1825 MacArthur Blvd NW, Atlanta, GA 30318', latitude: '', longitude: '')
...
User.create!(id: 1, client_id:1, email: 'danmilo@gmail.com', encrypted_password: 'danmilo333', is_event_admin: true)
User.create!(id: 2, client_id:1, email: 'harryk@gmail.com', encrypted_password: 'harryk333', is_event_admin: true)
User.create!(id: 3, client_id:1, email: 'michaelt@gmail.com', encrypted_password: 'michael333', is_event_admin: true)
